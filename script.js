...
//Mostrar Contáctame
 const botonEscribeme = document.getElementById("btn-escribir");
 function mostrarEscribeme(){
    const escribemeSection = document.getElementById("escribeme");
    escribemeSection.scrollIntoView({ behavior:"smooth"});
}
botonEscribeme.addEventListener("click", mostrarEscribeme);
...
// Tarea llamar a una clase para cambiar de tema
